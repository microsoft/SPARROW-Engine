...
- **`orca-cascade`** — Pipeline descriptor combining orca-detector-fp16-tflite and orca-ecotype-melinput-fp16-tflite. Cite both component model references; cascade artifact first published in Sparrow Engine model zoo v0.7.0, https://doi.org/10.5281/zenodo.20723037.
