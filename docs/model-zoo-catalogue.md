...
> Auto-generated from [`sparrow-engine/scripts/catalog.toml`](../sparrow-engine/scripts/catalog.toml) — the single source of truth. **70 models**, Zenodo record [`21813241`](https://zenodo.org/records/21813241) (v0.25.0, concept DOI [`10.5281/zenodo.20348978`](https://doi.org/10.5281/zenodo.20348978)).
...
| orca-detector-dclde2026-v5 | `orca-detector-dclde2026-v5` | DCLDE-orca | onnx · v5 | Detector · gates on Orca | North Pacific — Pacific Northwest and Salish Sea | Microsoft AI for Good Lab (AI4G) | First-party (AI4G) | MIT | ✅ |
| orca-detector-v5-fp16-tflite | `orca-detector-v5-fp16-tflite` | DCLDE-orca | tflite-fp16 · v5 | Detector · gates on Orca | North Pacific — Pacific Northwest and Salish Sea | Microsoft AI for Good Lab (AI4G) | First-party (AI4G) | MIT | ✅ |
| orca-detector-v5-int8-tflite | `orca-detector-v5-int8-tflite` | DCLDE-orca | tflite-int8 · v5 | Detector · gates on Orca | North Pacific — Pacific Northwest and Salish Sea | Microsoft AI for Good Lab (AI4G) | First-party (AI4G) | MIT | ✅ |
...
| Display name | ID | Family | Format / version | Behavior | Geography / locality | Developer / owner | AI4G relationship | License | Commercial use |
|---|---|---|---|---|---|---|---|---|---|
| FathomNet MBARI 315k Detector | `fathomnet-mbari-315k` | FathomNet, YOLOv8 | onnx | Detector · direct species output | North America — Monterey Bay, California, USA | CVisionAI / Monterey Bay Aquarium Research Institute (MBARI) | Third-party | CC-BY-4.0 | ✅ |
...
| FathomNet MegaFishDetector YOLOv5s 640 | `fathomnet-megafish-yolov5s-640` | FathomNet, MegaFishDetector, YOLOv5 | onnx · v0 | Detector · gates on fish | Global | WARPLab, Woods Hole Oceanographic Institution; distributed via FathomNet | Third-party | MIT | ✅ |
| FathomNet MegaFishDetector YOLOv5m 1280 | `fathomnet-megafish-yolov5m-1280` | FathomNet, MegaFishDetector, YOLOv5 | onnx · v0 | Detector · gates on fish | Global | WARPLab, Woods Hole Oceanographic Institution; distributed via FathomNet | Third-party | MIT | ✅ |
| FathomNet MegaFishDetector YOLOv5l 640 | `fathomnet-megafish-yolov5l-640` | FathomNet, MegaFishDetector, YOLOv5 | onnx · v0 | Detector · gates on fish | Global | WARPLab, Woods Hole Oceanographic Institution; distributed via FathomNet | Third-party | MIT | ✅ |
...
- **`MDV6-yolov10-c`** — MegaDetector V6 model zoo, Microsoft AI for Good Lab (AI4G); https://raw.githubusercontent.com/microsoft/MegaDetector/main/docs/model_zoo.md; weights DOI: https://doi.org/10.5281/zenodo.15398270
...
- **`MDV6-yolov10-e`** — MegaDetector V6 model zoo, Microsoft AI for Good Lab (AI4G); https://raw.githubusercontent.com/microsoft/MegaDetector/main/docs/model_zoo.md; weights DOI: https://doi.org/10.5281/zenodo.15398270
...
- **`european_mammals`** — Microsoft AI for Good Lab (AI4G) regional YOLO detector (European mammals); canonical upstream URL UNVERIFIED; Sparrow redistribution DOI: https://doi.org/10.5281/zenodo.20563673
- **`north_american_mammals`** — Microsoft AI for Good Lab (AI4G) regional YOLO detector (North American mammals); canonical upstream URL UNVERIFIED; Sparrow redistribution DOI: https://doi.org/10.5281/zenodo.20563673
- **`sub_saharan`** — Microsoft AI for Good Lab (AI4G) regional YOLO detector (Sub-Saharan mammals); canonical upstream URL UNVERIFIED; Sparrow redistribution DOI: https://doi.org/10.5281/zenodo.20563673
...
- **`MDV6-yolov9-c`** — MegaDetector V6 model zoo, Microsoft AI for Good Lab (AI4G); https://raw.githubusercontent.com/microsoft/MegaDetector/main/docs/model_zoo.md; weights DOI: https://doi.org/10.5281/zenodo.15398270
- **`MDV6-yolov9-e`** — MegaDetector V6 model zoo, Microsoft AI for Good Lab (AI4G); https://raw.githubusercontent.com/microsoft/MegaDetector/main/docs/model_zoo.md; weights DOI: https://doi.org/10.5281/zenodo.15398270
- **`MDV6-rtdetr-c`** — MegaDetector V6 model zoo, Microsoft AI for Good Lab (AI4G); https://raw.githubusercontent.com/microsoft/MegaDetector/main/docs/model_zoo.md; weights DOI: https://doi.org/10.5281/zenodo.15398270
- **`MDV6-mit-yolov9-c`** — MegaDetector V6 MIT YOLO-MIT variant, Microsoft AI for Good Lab (AI4G); https://raw.githubusercontent.com/microsoft/MegaDetector/main/docs/model_zoo.md; weights DOI: https://doi.org/10.5281/zenodo.15398270
- **`MDV6-mit-yolov9-e`** — MegaDetector V6 MIT YOLO-MIT variant, Microsoft AI for Good Lab (AI4G); https://raw.githubusercontent.com/microsoft/MegaDetector/main/docs/model_zoo.md; weights DOI: https://doi.org/10.5281/zenodo.15398270
- **`MDV6-apa-rtdetr-c`** — MegaDetector V6 Apache RT-DETR variant, Microsoft AI for Good Lab (AI4G); https://raw.githubusercontent.com/microsoft/MegaDetector/main/docs/model_zoo.md; weights DOI: https://doi.org/10.5281/zenodo.15398270
- **`MDV6-apa-rtdetr-e`** — MegaDetector V6 Apache RT-DETR variant, Microsoft AI for Good Lab (AI4G); https://raw.githubusercontent.com/microsoft/MegaDetector/main/docs/model_zoo.md; weights DOI: https://doi.org/10.5281/zenodo.15398270
- **`AI4G-Amazon-V2`** — Microsoft AI for Good Lab (AI4G), Biodiversity model-zoo classifier table (AI4G-Amazon-V2 v2): https://microsoft.github.io/Biodiversity/model_zoo/classifiers/
- **`AI4G-Serengeti`** — Microsoft AI for Good Lab (AI4G), Biodiversity model-zoo classifier table (AI4G-Serengeti): https://microsoft.github.io/Biodiversity/model_zoo/classifiers/
...
- **`southwest-usa-v3`** — San Diego Zoo Wildlife Alliance, Southwest USA v3 model card: https://huggingface.co/Addax-Data-Science/Southwest_USA_v3
- **`peruvian-andes`** — San Diego Zoo Wildlife Alliance, Peruvian Andes model card: https://huggingface.co/Addax-Data-Science/Peruvian_Andes
...
- **`gifu-japan`** — Gifu University, Japan Gifu v0.2 model card: https://huggingface.co/Addax-Data-Science/Japan_Gifu_v0.2
- **`hawaii-puaa`** — Addax Data Science, Hawaii AI Puaa v1.0 model card: https://huggingface.co/Addax-Data-Science/HWI-ADS-v1
...
- **`deep-forest-vision`** — MNHN-OFVI. AFR-DFV-v1 / DeepForestVision classifier. Hugging Face model repository: https://huggingface.co/Addax-Data-Science/AFR-DFV-v1; original project: https://github.com/MNHN-OFVI/DeepForestVision
- **`awc135`** — Australian Wildlife Conservancy. AWC135-AWC-v1 / Australian Wildlife Classifier. Hugging Face model repository: https://huggingface.co/Addax-Data-Science/AWC135-AWC-v1; source license: https://github.com/Australian-Wildlife-Conservancy-AWC/awc-wildlife-classifier/blob/main/LICENSE
...
- **`queensland`** — WildObs. WetTropics_WildObs (Queensland Wet Tropics classifier). Hugging Face model repository: https://huggingface.co/Addax-Data-Science/WetTropics_WildObs
- **`nz-species`** — New Zealand Department of Conservation / wekaResearch. NZS-WEK-v3-03 (New Zealand Species v3.03 classifier). Hugging Face model repository: https://huggingface.co/Addax-Data-Science/NZS-WEK-v3-03
- **`tropicam-ai`** — Andrea Zampetti / MNCN-CSIC. NEO-MNCN-v1-0 / TropiCam-AI v1.0 classifier. Hugging Face model repository: https://huggingface.co/Addax-Data-Science/NEO-MNCN-v1-0; original project: https://github.com/andrewzamp/TropiCam-AI
...
- **`tasmanian-vertebrates`** — MEWC. Tasmanian_vertebrates classifier. Hugging Face model repository: https://huggingface.co/Addax-Data-Science/Tasmanian_vertebrates; MEWC source: https://github.com/zaandahl/mewc
- **`peruvian-amazon-sdzwa`** — San Diego Zoo Wildlife Alliance. Peruvian_Amazon classifier. Hugging Face model repository: https://huggingface.co/Addax-Data-Science/Peruvian_Amazon
...
- **`orca-detector-dclde2026-v5`** — Microsoft AI for Good Lab (AI4G) and Microsoft Pytorch-Wildlife project. Sparrow Engine model zoo v0.21.0: orca-detector-dclde2026-v5. Zenodo. https://doi.org/10.5281/zenodo.21346269. Upstream/challenge context: DCLDE 2026 killer whale detection and ecotype classification dataset/challenge.
- **`orca-detector-v5-fp16-tflite`** — Converted TFLite FP16 variant of orca-detector-dclde2026-v5. Reference the ONNX sibling: Microsoft AI for Good Lab (AI4G) and Microsoft Pytorch-Wildlife project, Sparrow Engine model zoo v0.21.0, https://doi.org/10.5281/zenodo.21346269.
- **`orca-detector-v5-int8-tflite`** — Converted TFLite INT8 variant of orca-detector-dclde2026-v5. Reference the ONNX sibling: Microsoft AI for Good Lab (AI4G) and Microsoft Pytorch-Wildlife project, Sparrow Engine model zoo v0.21.0, https://doi.org/10.5281/zenodo.21346269.
- **`orca-ecotype-dclde2026-v1`** — Microsoft AI for Good Lab (AI4G) and Microsoft Pytorch-Wildlife project. Sparrow Engine model zoo v0.5.0: orca-ecotype-dclde2026-v1. Zenodo. https://doi.org/10.5281/zenodo.20563673. Upstream/challenge context: DCLDE 2026 killer whale detection and ecotype classification dataset/challenge.
